...
public class StreamingExampleActivity extends AppCompatActivity {
    ...
    private Button btn_start_streaming;
    private Button show_player;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        show_player = findViewById(R.id.show_player);
        ...
        Button showbtn = findViewById(R.id.show_player);
    ...
    public void onConfigurationChanged(@NonNull Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            playerView.setVisibility(View.VISIBLE);
            btn_start_streaming.setVisibility(View.GONE);
            show_player.setVisibility(View.GONE);
            ...
            btn_start_streaming.setVisibility(View.VISIBLE);
            ViewGroup.LayoutParams layoutParams = playerView.getLayoutParams();
            layoutParams.width = ViewGroup.LayoutParams.MATCH_PARENT;
